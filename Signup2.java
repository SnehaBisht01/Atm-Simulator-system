 ...
 public class Signup2 extends JFrame  implements ActionListener{
	 ...
	 JRadioButton syes, sno,eyes, eno;
      ...
      String formno;
		 ...
		 String valReligion[]= {"Hindu","Muslium","Sikh","Christan","other"};
	...
	public void actionPerformed(ActionEvent ae) { 
	 ...
	 if(eyes.isSelected()) {
	  ...
	  try {
			...
			String query ="INSERT INTO Signup2 VALUES('"+formno+"', '"+sreligion+"','"+scategory+"','"+sincome+"','"+seducation+"','"+socupation+"','"+span+"','"+saadhar+"','"+seniorcitizen+"','"+exisitingaccount+"')";
